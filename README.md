...
> Image-Gallery is web Application that shows the Images of Various categories, possess a mini authentication and super Drag and Drop effect .
...
This app is build with NextJS, Tailwind and DND-KIT.
...
> - Explore images from various categories.
> - slik Drag and DRop effect.
> - Perform Image searches by titles or keywords.
...
```sh
 git clone https://github.com/Tobby8629/Image-Gallery_HNG.git
```

- Navigate into the cloned folder

```sh
 cd Image-Gallery_HNG
...
Feel free to check the [issues page](https://github.com/Tobby8629/Image-Gallery_HNG/issues).
...
This project is [MIT](https://github.com/Tobby8629/Image-Gallery_HNG/blob/development/LICENSE) licensed.
